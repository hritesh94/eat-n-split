...
export default function App() {
  ...
  function handleShowAddFriend() {
    //we use a callback 👇here to set the state opposite to the current state (we cannot do it directly like !show so we need callback function)
    ...
    <div className="app">
      ...
      {selectedFriend && (
        <FormSplitBill
          ...
          //👇 this key helps us to reset the state for each friend o/w the same bill will be rendered for each friend so with the same state(diffing lec 129-132)
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input
        type="text"
        value={paidByUser}
        //                             so basically here👇 we are checking if any of the values doenst become negative
        onChange={(e) =>
